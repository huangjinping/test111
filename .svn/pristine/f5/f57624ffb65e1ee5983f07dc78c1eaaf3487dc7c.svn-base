...
{
    FACIAL_ACTION_UNKOWN = 0,
    FACIAL_ACTION_MOUTH_OPEN = 1,
    FACIAL_ACTION_EYE_CLOSE = 3,
    FACIAL_ACTION_CAPTURE = 50,
    FACIAL_ACTION_HEAD_LEFT = 51,
    FACIAL_ACTION_HEAD_RIGHT = 52,
    FACIAL_ACTION_HEAD_UP = 53,
    FACIAL_ACTION_HEAD_DOWN = 54,
    FACIAL_ACTION_HEAD_SHAKE_SIDE_TO_SIDE = 60
};
