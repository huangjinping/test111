...
@property (weak, nonatomic) IBOutlet UIImageView *countImageBgView;
...
- (void)updateDisplay
{
    ...
    self.countImageBgView.hidden = self.countLabel.hidden;
    ...
    if (self.picker.selectedOriginalImage) {
        ...
        self.boxImageView.image = [UIImage imageNamed:@"Photo Camera Button - Inactive"];
...
- (void)reloadCheckButtonBgColor
{
    ...
    self.checkImageView.image = _pageSelected ? [UIImage imageNamed:@"USPicker-Checkmark_blue"] : [[UIImage imageNamed:@"USPicker-Checkmark-Selected"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
